(function ($, undefined) {;;
    var defaults = {
        ...
        , weekNumberTitle: 'W', // editing
        //editable: false,
        //disableDragging: false,
        //disableResizing: false,
        allDayDefault: true
        , ignoreTimezone: true, // event ajax
        lazyFetching: true
        , startParam: 'start'
        , endParam: 'end', // time formats
        titleFormat: {
            month: 'MMMM yyyy'
    ...
    function EventManager(options, _sources) {
        ...
        function updateEvent(event) { // update an existing event
            var i, len = cache.length
                , e, defaultEventEnd = getView().defaultEventEnd, // getView???
    ...
    */
    ...
    function AgendaView(element, calendar, viewName) {
        ...
        function buildSkeleton() {
            ...
            slotSegmentContainer = $("<div style='position:absolute;z-index:8;top:0;left:0'/>").appendTo(slotContainer);
    ...
    function AgendaEventRenderer() {
        ...
        function compileSlotSegs(events) {
            ...
            for (i = 0; i < colCnt; i++) {
                d = cellToDate(0, i);
                addMinutes(d, minMinute);
                col = stackAgendaSegs(sliceSegs(events, visEventEnds, d, addMinutes(cloneDate(d), maxMinute - minMinute)));
        ...
        function slotSegHtml(event, seg) {
            ...
            html += " class='" + classes.join(' ') + "'" + " style='position:absolute;z-index:8;top:" + seg.top + "px;left:" + seg.left + "px;" + skinCss + "'" + ">" + "<div class='fc-event-inner'>" + "<div class='fc-event-time'>" + htmlEscape(formatDates(event.start, event.end, opt('timeFormat'))) + "</div>" + "<div class='fc-event-title'>" + htmlEscape(event.title) + "</div>" + "</div>" + "<div class='fc-event-bg'></div>";
                            ...
                            if (!cell.row) {
                                ...
                                if (isStart) {
                                    if (allDay) {
                                        ...
                                        setOuterHeight(eventElement, snapHeight * Math.round(
                                            (event.end ? ((event.end - event.start) / MINUTE_MS) : opt('defaultEventMinutes')) / snapMinutes));
    ...
    function DayEventRenderer() {
        ...
        function renderTempDayEvent(event, adjustRow, adjustTop) {
			...
			[event], true, // append event elements
        ...
        function buildHTMLForSegment(segment) {
            ...
            html += " class='" + classNames.join(' ') + "'" + " style=" + "'" + "position:absolute;" + "z-index:8;" + // TODO: move this into a constant or put it in the stylesheet
                "left:" + segment.left + "px;" + skinCss + "'" + ">" + "<div class='fc-event-inner'>";
